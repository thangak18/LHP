...
Mỗi chủ đề có định nghĩa, lý thuyết chi tiết, giải thích vì sao thuật toán hoạt động, phương pháp sử dụng, 2 ví dụ áp dụng, mã giả và code C++17 mẫu. Riêng Level 2 có thêm danh sách 202 bài duy nhất từ roadmap OJ, bộ lọc theo dạng bài, sample input/output thật từ đề, và hướng dẫn từng bài. Mỗi bài có code C++17 để mở xem; bài có nhãn "Đáp án đã kiểm" là bài đã có lời giải riêng được compile và chạy sample.
